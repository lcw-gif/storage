...
```bash
git remote add encore encore://website-clone-n2y2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/website-clone-n2y2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/website-clone-n2y2/settings/integrations/github)
